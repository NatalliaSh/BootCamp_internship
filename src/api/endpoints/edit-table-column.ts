...
export const editTableColumn = bootCampBoardAPI.injectEndpoints({
  endpoints: (builder) => ({
    editTableColumn: builder.mutation<EditTableResp, EditTableColumnOrRow>({
      query: (data) => ({
        url: API_URL.editTableColumn,
        method: 'PATCH',
        body: data,
      }),
